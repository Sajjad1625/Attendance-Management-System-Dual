...
def share_stream():
    ...
    f1 = open("./files/camera_resolution.txt", "w")
    ...
    try:
        shared_image = shared_memory.SharedMemory(create=True, size=raw_image.nbytes, name="shared_raw_image")
    except FileExistsError:
        shared_image = shared_memory.SharedMemory(create=False, size=raw_image.nbytes, name="shared_raw_image")
        shared_image.unlink()
    ...
    print("Started Sharing Stream through: ", shared_image.name)
